...
enum opt_code
{
  ...
  OPT_momit_leaf_frame_pointer = 1148,       /* -momit-leaf-frame-pointer */
  OPT_mstrict_align = 1149,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1150,                  /* -mtls-dialect= */
  OPT_mtune_ = 1151,                         /* -mtune= */
  OPT_muclibc = 1152,                        /* -muclibc */
  OPT_n = 1153,                              /* -n */
  OPT_no_canonical_prefixes = 1154,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1155,              /* -no-integrated-cpp */
  OPT_nocpp = 1156,                          /* -nocpp */
  OPT_nodefaultlibs = 1157,                  /* -nodefaultlibs */
  OPT_nopie = 1158,                          /* -nopie */
  OPT_nostartfiles = 1159,                   /* -nostartfiles */
  OPT_nostdinc = 1160,                       /* -nostdinc */
  OPT_nostdinc__ = 1161,                     /* -nostdinc++ */
  OPT_nostdlib = 1162,                       /* -nostdlib */
  OPT_o = 1163,                              /* -o */
  OPT_p = 1164,                              /* -p */
  OPT_pass_exit_codes = 1165,                /* -pass-exit-codes */
  /* OPT_pedantic = 1166, */                 /* -pedantic */
  OPT_pedantic_errors = 1167,                /* -pedantic-errors */
  OPT_pg = 1168,                             /* -pg */
  OPT_pie = 1169,                            /* -pie */
  OPT_pipe = 1170,                           /* -pipe */
  OPT_posix = 1171,                          /* -posix */
  OPT_print_file_name_ = 1172,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1173,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1174,          /* -print-multi-directory */
  OPT_print_multi_lib = 1175,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1176,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1177,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1178,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1179,               /* -print-prog-name= */
  OPT_print_search_dirs = 1180,              /* -print-search-dirs */
  OPT_print_sysroot = 1181,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1182,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1183,                        /* -profile */
  OPT_pthread = 1184,                        /* -pthread */
  OPT_quiet = 1185,                          /* -quiet */
  OPT_r = 1186,                              /* -r */
  OPT_rdynamic = 1187,                       /* -rdynamic */
  OPT_remap = 1188,                          /* -remap */
  OPT_s = 1189,                              /* -s */
  OPT_s_bc_abi = 1190,                       /* -s-bc-abi */
  OPT_save_temps = 1191,                     /* -save-temps */
  OPT_save_temps_ = 1192,                    /* -save-temps= */
  OPT_shared = 1193,                         /* -shared */
  OPT_shared_libgcc = 1194,                  /* -shared-libgcc */
  /* OPT_specs = 1195, */                    /* -specs */
  OPT_specs_ = 1196,                         /* -specs= */
  OPT_static = 1197,                         /* -static */
  OPT_static_libasan = 1198,                 /* -static-libasan */
  OPT_static_libgcc = 1199,                  /* -static-libgcc */
  OPT_static_libgcj = 1200,                  /* -static-libgcj */
  OPT_static_libgfortran = 1201,             /* -static-libgfortran */
  OPT_static_libgo = 1202,                   /* -static-libgo */
  OPT_static_liblsan = 1203,                 /* -static-liblsan */
  OPT_static_libmpx = 1204,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1205,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1206,               /* -static-libstdc++ */
  OPT_static_libtsan = 1207,                 /* -static-libtsan */
  OPT_static_libubsan = 1208,                /* -static-libubsan */
  /* OPT_std_c__03 = 1209, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1210, */                /* -std=c++0x */
  OPT_std_c__11 = 1211,                      /* -std=c++11 */
  OPT_std_c__14 = 1212,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1213, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1214, */                /* -std=c++1y */
  OPT_std_c__1z = 1215,                      /* -std=c++1z */
  OPT_std_c__98 = 1216,                      /* -std=c++98 */
  OPT_std_c11 = 1217,                        /* -std=c11 */
  /* OPT_std_c1x = 1218, */                  /* -std=c1x */
  /* OPT_std_c89 = 1219, */                  /* -std=c89 */
  OPT_std_c90 = 1220,                        /* -std=c90 */
  OPT_std_c99 = 1221,                        /* -std=c99 */
  /* OPT_std_c9x = 1222, */                  /* -std=c9x */
  OPT_std_f2003 = 1223,                      /* -std=f2003 */
  OPT_std_f2008 = 1224,                      /* -std=f2008 */
  OPT_std_f2008ts = 1225,                    /* -std=f2008ts */
  OPT_std_f95 = 1226,                        /* -std=f95 */
  OPT_std_gnu = 1227,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1228, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1229, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1230,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1231,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1232, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1233, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1234,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1235,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1236,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1237, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1238, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1239,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1240,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1241, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1242, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1243,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1244, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1245, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1246, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1247,                     /* -std=legacy */
  OPT_symbolic = 1248,                       /* -symbolic */
  OPT_t = 1249,                              /* -t */
  OPT_time = 1250,                           /* -time */
  OPT_time_ = 1251,                          /* -time= */
  OPT_traditional = 1252,                    /* -traditional */
  OPT_traditional_cpp = 1253,                /* -traditional-cpp */
  OPT_trigraphs = 1254,                      /* -trigraphs */
  OPT_u = 1255,                              /* -u */
  OPT_undef = 1256,                          /* -undef */
  OPT_v = 1257,                              /* -v */
  OPT_version = 1258,                        /* -version */
  OPT_w = 1259,                              /* -w */
  OPT_wrapper = 1260,                        /* -wrapper */
  OPT_x = 1261,                              /* -x */
  OPT_z = 1262,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
