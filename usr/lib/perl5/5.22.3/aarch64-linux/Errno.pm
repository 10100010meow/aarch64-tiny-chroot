...
"aarch64-linux-3.18.0-13745-gf83aa11" or
	die "Errno architecture (aarch64-linux-3.18.0-13745-gf83aa11) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
